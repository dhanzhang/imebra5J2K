...
{
//    imebra::DataSet ds =imebra::CodecFactory::load("/home/dhz/cvt/cg2.dcm");
    imebra::DataSet ds =imebra::CodecFactory::load("/home/dhz/CR_1.3.46.670589.26.902153.4.20190502.90700.714171.0.dcm");
    std::cout << ds.getString(TagId(imebra::tagId_t::TransferSyntaxUID_0002_0010),0) << std::endl;
    imebra::Image  dimg = ds.getImage(0);
    std::cout << dimg.getWidth() << std::endl;
